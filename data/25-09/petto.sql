...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/09/2025 às 14:16
...
(72, 'Thais', 'Teste', '10 anos', NULL, 'thais.casagrande@fatectq.edu.br', 'Rua General Osório', '15900-013', 'Centro', '11', '333.333.333-33', '12345-6', 96);
...
--
ALTER TABLE `veterinarios`
  MODIFY `id_veterinario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
