...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/08/2025 às 02:18
...
(74, 'jonatasmoraes05@gmail.com', '$2b$10$fLxbx0Et.JDamPQeSYPJyuJFQgNGyjUr.RWisJfgppiT75UA6fiAe', 'Jônatas', NULL, NULL, 'Tigre', 'Azul'),
(75, 'thais@email', '$2b$10$SZiF0s/cuu.9666/8t9L..VOrcY8FBRDjXhsfMER0R7el1DF4oOAG', 'Thais', NULL, NULL, 'Luna', 'Amarelo');
...
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
