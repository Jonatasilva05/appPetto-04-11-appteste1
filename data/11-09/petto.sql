...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/09/2025 às 16:08
...
(14, 'vermifugo_oral_cao_gato', 96, 'Vermífugo (Comprimido Oral)', NULL, 0);
...
(96, 'Caramelo', 80, 'cachorro', 'chow_chow', NULL, NULL, NULL, NULL, 7, 'M', 'caramelo', '2025-05-25', '/uploads/2b8907668d873d737e0728074f6944b0.jpeg', NULL);
...
(19, 'vacina_v10_cao', 'Polivalente V8 ou V10 (Cinomose, Parvovirose, etc.)', NULL, '0000-00-00', 0, 96);
...
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `vacinas`
  MODIFY `id_vacina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
