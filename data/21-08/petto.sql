...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/08/2025 às 15:20
...
(8, 78, 'Vermífugo (Remédio para Verme - Comprimido Oral)', '2025-06-25', 0),
(9, 78, 'Vermífugo (Remédio para Verme - Injetável)', '2025-06-25', 0);
...
(78, 'Caramelo', 80, 'cachorro', 'chow_chow', NULL, NULL, NULL, NULL, 7, 'M', 'Caramelado', '2025-05-20', NULL, NULL),
...
(14, 'Polivalente V8 ou V10 (Cinomose, Parvovirose, etc.)', '2025-06-15', '0000-00-00', 0, 78),
...
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `vacinas`
  MODIFY `id_vacina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
