...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/08/2025 às 03:06
...
(80, 'jonatasmoraes05@gmail.com', '$2b$10$l9CdS5iHIuWsauPdyN4NeeFqf.Gfp8oNh3B0CNBc7ICgtVmnbcY6a', 'Jônatas', NULL, NULL, 'Tigre', 'Azul');
...
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
