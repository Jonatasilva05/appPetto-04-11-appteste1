...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/06/2025 às 06:24
...
INSERT INTO `pets` (`id_pet`, `nome`, `id_usuario`, `especie`, `raca`, `idade_valor`, `idade_unidade`, `peso`, `sexo`, `cor`, `id_veterinario`) VALUES
(50, 'Rex', 63, 'Cachorro', 'Pastor Alemão', 5, 'anos', 30, 'M', 'Preto e Bege', 65),
(51, 'Thor', 64, 'Cachorro', 'Bulldog Francês', 4, 'anos', 12, 'M', 'Creme', 67),
(54, 'Caramelo ', 68, 'cachorro', 'chow_chow', 2, 'meses', NULL, 'M', 'Caramelo ', NULL),
(56, 'Caraca', 69, 'tartaruga', 'jabuti_piranga', 15, 'anos', 15, 'M', 'Verde', NULL),
(58, 'Fui', 68, 'peixe', 'carpa', 5, 'anos', NULL, 'F', 'V get', NULL);
...
(69, 'testandoteste@gmail.com', '$2b$10$ZOu5nYmXEJ2uwmm9lK91aeLtunBFIvZxYcUxaMsDe4eYFnKyDJaIO', 'Testando', NULL, NULL);
...
--
ALTER TABLE `pets`
  MODIFY `id_pet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `vacinas`
  MODIFY `id_vacina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
